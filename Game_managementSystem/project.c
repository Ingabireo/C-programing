...
void get_time(int a,char time[10])
{
	...
	switch(a)
	{
		...
		case 4:
			...
			break;
		case 5:
			strcpy(time,"15:00 PM");
			break;
		case 6:
			strcpy(time,"17:00 PM");
			break;
		case 7:
			strcpy(time,"19:00 PM");
			break;
		case 8:
			strcpy(time,"21:00 PM");
			break;
	}
}
...
void print_time()
{
    printf("bus 1 4:00  AM\n");
	printf("bus 2 6:00  AM\n");
	printf("bus 3 9:00  AM\n");
	printf("bus 4 12:00 PM\n");
	printf("bus 5 15:00 PM\n");
	printf("bus 6 17:00 PM\n");
	printf("bus 7 19:00 PM\n");
	printf("bus 8 21:00 PM\n\n");
...
void book_ticket()
{
	...
	int n;
	if(check_full(bus.dest,bus.num)<=30)
    {
...
int main()
{
    ...
    printf("|  Press 4 To see a number of seats available in a certain bus |\n");
    printf("|  Press 0 to exit                                             |\n");
    printf("|                                                              |\n");
    printf("|--------------------------------------------------------------|\n");
    scanf("%d",&choice);
    ...
    case 4:
        ...
        scanf("%d",&number);
        printf("The Bus you entered has %d Places available\n\n",30 - check_full(dest,number));
        break;
    default:
        printf(" Wrong choice\n");
        break;
